...
MEMORY
{
    ...
    RAM                     : origin = 0x1C00, length = 0x3D00	//it was 0x4000
    RAM_CODE				: origin = 0x5900, length = 0x0300	//reserved ram for running code
    INFOA                   : origin = 0x1980, length = 0x0080
    INFOB                   : origin = 0x1900, length = 0x0080
    INFOC                   : origin = 0x1880, length = 0x0080
    INFOD                   : origin = 0x1800, length = 0x0080
    FLASH                   : origin = 0x5C00, length = 0xA080	//it was A380
    FLASH_RAM				: origin = 0xFC80, length = 0x0300	//code to run on ram
    FLASH2                  : origin = 0x10000,length = 0xFFFF
    FLASH3                  : origin = 0x20000,length = 0xFFFF //copia backup
    FLASH4                  : origin = 0x30000,length = 0xFFFF //copia backup
    FLASH5                  : origin = 0x40000,length = 0x5BFF //informazioni statiche, magicword,etcc...
